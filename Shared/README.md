...
2. `Resources/Shared/slides/bootcamp_deck.md` dosyasını açın.
...
npx @marp-team/marp-cli@latest Resources/Shared/slides/bootcamp_deck.md -o Resources/Shared/slides/bootcamp_deck.html

# PDF formatında yüksek çözünürlüklü dışa aktarma
npx @marp-team/marp-cli@latest Resources/Shared/slides/bootcamp_deck.md --pdf -o Resources/Shared/slides/bootcamp_deck.pdf
```
...
`Resources/Shared/diagrams/` altındaki diyagramlar:
